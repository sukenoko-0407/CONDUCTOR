...
対象Versionは`0.1.1`です。CONDUCTORは、Description、Clustering、Operator、Interpretationを疎結合なSkillとして接続し、一つの入力・endpointを複数Roundで探索するSAR解析基盤です。
...
- [CONDUCTOR_0.1.1_vector_clustering_refactoring_plan.md](CONDUCTOR_0.1.1_vector_clustering_refactoring_plan.md): 本Versionの実装計画・判断記録
- [CONDUCTOR_0.1.0_to_0.1.1_description_migration.md](CONDUCTOR_0.1.0_to_0.1.1_description_migration.md): 旧RunからDescriptionだけを引き継ぐ一回限りの手順
