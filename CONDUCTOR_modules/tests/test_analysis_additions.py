...
class AnalysisAdditionTests(unittest.TestCase):
    ...
    def test_fixed_interpretation_renderer(self)->None:
        ...
        report={"schema_version":"4.0.0","run_id":"run","round_id":"RND0001","node_id":"N000021","title":"解析結果","report_header":{"project":"p","endpoint":"pIC50","higher_is_better":True,"endpoint_unit":None,"endpoint_transform":None,"completion":"complete"},"executive_summary":"C000001を対象とした局所SALI解析では、Globalとは区別された局所的な変化候補を確認した。ただし反証探索は限定的であり、現段階では機序を断定できない。","coverage_summary":"当該Roundから選択された単一ClusterのOperator Result一件を詳細確認した。未選択Bundleはなく、別Descriptionによる独立な確認は今後の課題である。","created_at":"2026-01-01T00:00:00+00:00","insights":[{"insight_id":"INS000001","revision":1,"title":"C000001の局所変化","observation":"C000001を対象としたSALI結果において、同一Metricで評価した局所集合内の数値変化が観察された。対象は30化合物であり、Cluster-local結果として記録された。","interpretation":"この観察はC000001に限定された局所的なLandscape変化の候補を示す。ただし独立な比較Resultがないため、別Clusterへの一般化はまだ判断できない。","attention":"active","claim_kind":"single_scope_observation","analysis_subject":subject,"supporting_results":["N000020@ATT0001"],"comparison_results":[],"counter_results":[],"limitations":["反証探索は限定的である。"],"recommended_followups":[{"title":"別表現で確認","rationale":"独立性を高める。"}],"fact_panel":{"clustering_method":"C005","cluster_source_descriptions":["N000001"],"analysis_descriptions":["N000002"],"operators":["A008"],"metrics":["tanimoto"],"result_samples":{"N000020@ATT0001":30},"key_metrics":{"N000020@ATT0001":{"private_metric_0x":987654.321}}}}],"result_catalog":[card],"review_manifest":{"schema_version":"2.0.0","round_id":"RND0001","selected_bundle_ids":["RVB0000000000000001"],"detailed_result_refs":["N000020@ATT0001"],"unselected_bundles":[],"candidate_class_counts":{"design_lead":1},"bundle_type_counts":{"global_local":1},"operator_counts":{"A008":1},"selection_method":"candidate_class_reliability_actionability_diversity","created_at":"2026-01-01T00:00:00+00:00"}}
