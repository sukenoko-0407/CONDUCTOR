...
description: Apply Vector Leiden clustering to a numeric vector artifact produced by a Description Skill; do not accept SMILES or generate descriptors internally. General mode is the default; use CONDUCTOR mode only as an explicit opt-in with complete project, run, and node context.
allowed-tools: Read, Write, Bash, Glob, Grep
---

# Vector Leiden clustering

## Purpose

Description Skillが生成した数値vectorへVector Leiden clusteringを適用し、Clustering artifactを生成する。
