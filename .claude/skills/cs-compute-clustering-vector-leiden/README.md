...
数値DescriptionからVector Leiden clusteringを実行し、cluster membershipとsummaryを生成する。
...
```bash
python .claude/skills/cs-compute-clustering-vector-leiden/scripts/launch.py --input description.csv
```
