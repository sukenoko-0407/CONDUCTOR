...
```bash
python .claude/skills/cs-analysis-activity-distribution/scripts/launch.py --input compounds.csv --property-column pIC50 --higher-is-better --conductor --project PROJECT --run-id RUN_ID --node-id NODE_ID
```
