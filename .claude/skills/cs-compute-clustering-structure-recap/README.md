...
```bash
python .claude/skills/cs-compute-clustering-structure-recap/scripts/launch.py --input compounds.csv --conductor --project PROJECT --run-id RUN_ID --node-id NODE_ID
```
