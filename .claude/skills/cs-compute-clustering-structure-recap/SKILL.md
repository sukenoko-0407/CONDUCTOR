...
description: Group compounds directly from SMILES with RECAP fragment. Use for general clustering or an explicitly planned CONDUCTOR v4 structural Grouping node; this Skill does not consume Description vectors or hide a fingerprint-generation step.
