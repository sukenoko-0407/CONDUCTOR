...
description: Render an explicitly supplied CONDUCTOR 0.1.3 Run Root as a read-only human DAG report. Use only on explicit human request and never as an analysis Node.
