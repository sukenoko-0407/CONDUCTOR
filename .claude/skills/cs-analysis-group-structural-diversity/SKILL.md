---
name: cs-analysis-group-structural-diversity
description: Use when Claude Code needs to run Group structural diversity from CSV or compatible CONDUCTOR v4 artifacts with a self-contained Pixi environment. General mode is the default; use CONDUCTOR mode only as an explicit opt-in with complete project, run, and node context.
allowed-tools: Read, Write, Bash, Glob, Grep
---

# Group structural diversity

## Purpose

Group structural diversityを実行し、客観的な数値結果とCONDUCTOR evidenceを生成する。
