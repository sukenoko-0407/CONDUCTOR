...
```bash
python "${CLAUDE_SKILL_DIR}/scripts/launch.py" --input compounds.csv --property-column pIC50 --higher-is-better --membership path/to/cluster_membership.csv --conductor --project PROJECT --run-id RUN_ID --node-id NODE_ID
```
