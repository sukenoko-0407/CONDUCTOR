...
```bash
python .claude/skills/cs-compute-description-mordred-3d/scripts/launch.py --input compounds.csv
```
...
```bash
python .claude/skills/cs-compute-description-mordred-3d/scripts/launch.py --input compounds.csv --conductor --project PROJECT --run-id RUN_ID --node-id NODE_ID
```
