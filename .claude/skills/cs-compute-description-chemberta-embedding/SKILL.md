...
```bash
python "${CLAUDE_SKILL_DIR}/scripts/launch.py" --input compounds.csv --model-dir /shared/models/ChemBERTa-100M-MLM --conductor --project PROJECT --run-id RUN_ID --round-id RND0001 --node-id N000001 --attempt-id ATT0001
```
