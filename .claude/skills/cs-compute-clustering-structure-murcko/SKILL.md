...
description: Group compounds from a compound-ID/SMILES CSV with Murcko scaffold. Use for general clustering or an explicitly planned CONDUCTOR v4 structural Grouping node; this Skill requires CSV input and does not consume Description vectors or hide a fingerprint-generation step.
