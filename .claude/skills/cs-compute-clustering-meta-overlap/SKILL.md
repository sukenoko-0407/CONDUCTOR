...
```bash
python "${CLAUDE_SKILL_DIR}/scripts/launch.py" --input path/to/cluster_membership.csv --conductor --project PROJECT --run-id RUN_ID --round-id RND0001 --node-id N000001 --attempt-id ATT0001
```
