...
```bash
python .claude/skills/cs-compute-clustering-vector-butina/scripts/launch.py --input description.csv
```
...
```bash
python .claude/skills/cs-compute-clustering-vector-butina/scripts/launch.py --input description.csv --conductor --project PROJECT --run-id RUN_ID --round-id RND0001 --node-id NODE_ID --attempt-id ATT0001
```
