...
```bash
python .claude/skills/cs-analysis-descriptor-activity-correlation/scripts/launch.py --input compounds.csv --property-column pIC50 --higher-is-better --description description.csv --conductor --project PROJECT --run-id RUN_ID --node-id NODE_ID
```
