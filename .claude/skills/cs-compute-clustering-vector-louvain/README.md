...
```bash
python .claude/skills/cs-compute-clustering-vector-louvain/scripts/launch.py --input description.csv --conductor --project PROJECT --run-id RUN_ID --node-id NODE_ID
```
