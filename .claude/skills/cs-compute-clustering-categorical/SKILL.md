...
```bash
python "${CLAUDE_SKILL_DIR}/scripts/launch.py" --input compounds.csv --columns assay --conductor --project PROJECT --run-id RUN_ID --round-id RND0001 --node-id N000001 --attempt-id ATT0001
```
