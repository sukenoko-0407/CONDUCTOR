...
CSVまたは1件以上のSMILESからRDKit pattern fingerprintを計算し、Description表を生成する。
...
```bash
python .claude/skills/cs-compute-description-rdkit-pattern-fingerprint/scripts/launch.py --input compounds.csv
```
