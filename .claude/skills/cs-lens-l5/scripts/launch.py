...
def main() -> int:
    ...
    for name, relative in {
        "PIXI_HOME": "pixi-home", "PIXI_CACHE_DIR": "cache/pixi", "UV_CACHE_DIR": "cache/uv",
        "PIP_CACHE_DIR": "cache/pip", "XDG_CACHE_HOME": "cache/xdg", "XDG_CONFIG_HOME": "config",
        "XDG_DATA_HOME": "data", "XDG_STATE_HOME": "state", "TMPDIR": "tmp", "TMP": "tmp", "TEMP": "tmp",
    }.items():
        path = skill / "env" / relative
