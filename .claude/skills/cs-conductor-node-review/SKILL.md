...
description: Inspect and apply narrowly defined human-confirmed corrections to a CONDUCTOR 0.1.2 Node. Use only on explicit human request; never expose arbitrary status editing and never include this Skill in the Orchestrator Agent.
